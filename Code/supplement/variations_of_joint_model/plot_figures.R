...
pdf('fig3a.pdf', onefile=T, width = 4, height = 8)
...
pdf('fig3b.pdf', onefile=T, width = 4, height = 5)
...
pdf('fig3c.pdf', onefile=T, width = 4, height = 3)
...
pdf('fig6a.pdf', onefile=T, width = 8, height = 4)
...
pdf('fig7b.pdf', onefile=T, width = 7, height = 4)
...
pdf('fig7c.pdf', onefile=T, width = 5, height = 4)
...
pdf('fig7d.pdf', onefile=T, width = 7, height = 4)
...
pdf('fig8.pdf', onefile=T, width = 10, height = 3)

fig8 <- cor_plt3(t2, 'incentive', 'avg_incentive', 'lci_incentive', 'uci_incentive', 'contestant')

fig8 + labs(x = 'Model', y='Data', title='Incentive', color='Contestant')
